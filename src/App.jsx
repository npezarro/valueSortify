...
export default function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <a
        href="#main-content"
        className="sr-only focus-visible:not-sr-only focus-visible:fixed focus-visible:top-4 focus-visible:left-4 focus-visible:z-50 focus-visible:px-4 focus-visible:py-2 focus-visible:rounded-full focus-visible:bg-ember focus-visible:text-white focus-visible:font-body focus-visible:text-sm focus-visible:font-medium focus-visible:shadow-card focus-visible:outline-none"
      >
        Skip to content
      </a>
